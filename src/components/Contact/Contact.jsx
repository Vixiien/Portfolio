...
const Contact = () => {
  ...
  return (
    <section
      id="contact"
      className="bg-white py-24 px-[12vw] md:px-[7vw] lg:px-[10vw] font-sans"
    >
      {/* Toast Container */}
      <ToastContainer />
      ...
      <div className="flex flex-col md:flex-row gap-12 justify-center items-start">
        ...
        {/* Contact Form */}
        <div className="w-full md:w-1/2 bg-white p-6 rounded-lg shadow-lg border border-gray-700">
          ...
          <form ref={form} onSubmit={sendEmail} className="mt-4 flex flex-col space-y-4">
            ...
            <button
              type="submit"
              className="w-40 bg-black py-3 text-white rounded-md hover:opacity-90 transition self-center"
            >
              Submit
            </button>
          </form>
        ...
        {/* Contact Info */}
        <div className="w-full max-w-xl mx-auto bg-white p-4 sm:p-6 rounded-lg shadow-lg border border-gray-300">
          <div className="flex items-start gap-4 mb-4 sm:mb-6">
            <div className="bg-[#0D1B2A] p-2 sm:p-3 rounded-md">
              <Mail className="text-white w-5 h-5" />
            </div>
            <div>
              <h4 className="text-black font-semibold text-base sm:text-lg">Email</h4>
              <p className="text-gray-600 text-sm sm:text-base">vicocasla14@gmail.com</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-4 mb-4 sm:mb-6">
            ...
            <div>
              <h4 className="text-black font-semibold text-base sm:text-lg">Phone Number</h4>
              <p className="text-gray-600 text-sm sm:text-base">+63 921-2335-490</p>
            </div>
          </div>
